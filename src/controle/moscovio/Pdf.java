...
public class Pdf {
    ...
    public void criaPDF(Integer fonte,String nomeArquivo,String Url) {
        ...
        try {
            ...
            documentoPDF.add(insImg.criarImagem("/imagens/moscovio/tituloCds.png", 556, 400, 26, 745));
            //Segunda Imagem de uma listra abaixo do titulo e data
            documentoPDF.add(insImg.criarImagem("/imagens/moscovio/divisor01.jpg", 550, 400, 30, 720));
            //Assinatura taanho,tamnhao, (esquerda- direita) , (altura)
            documentoPDF.add(insImg.criarImagem("/imagens/moscovio/assinaturaRecibo.jpg", 200, 400, 200, 450));
            //Segunda Imagem de uma listra no final do documento
            documentoPDF.add(insImg.criarImagem("/imagens/moscovio/divisor01.jpg", 550, 400, 30, 400));
